...
class database_utils:
	...
	def __init__(self):
		...
		self.CLOUDSQL_CONNECTION_NAME = db_data['Name']
		self.CLOUDSQL_USER = db_data['User']
		self.CLOUDSQL_PASSWORD = db_data['Password']
		self.CLOUDSQL_DB = db_data['DB']
    	...
    	#
			...
			self.db = MySQLdb.connect(
				host='34.87.225.205', user=self.CLOUDSQL_USER, passwd=self.CLOUDSQL_PASSWORD, 
